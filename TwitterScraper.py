...
class TwitterScraper(Scraper):
    """
    The TwitterScraper object is used to scrape based on a user specified query string
    ...
    def __init__(self, query, sample_size, hashtag=""):     #Probably can remove hashtag attribute
